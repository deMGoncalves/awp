...
const reflow = f.cond([isAddEventListener, addEventListener], [isAppendNode, appendNode], [isRemoveAttribute, removeAttribute], [isRemoveClassName, removeClassName], [isRemoveEventListener, removeEventListener], [isRemoveNode, removeNode], [isReplaceNode, replaceNode], [isSetAttribute, setAttribute], [isSetClassName, setClassName], [isSetTextContent, setTextContent]);
